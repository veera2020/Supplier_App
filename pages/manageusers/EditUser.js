...
const EditUser = ({ iseditopen, iseditclose, empID, setreload, reload }) => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        setSname(res.data.state);
        setDname(res.data.district);
      })
      .catch((err) => {
        console.error(err);
      });
  ...
  const initialvalue = {
    ...
    tradename: empdetails.tradeName,
    ctype: empdetails.companytype,
    contactname: empdetails.primaryContactName,
    contactno: empdetails.primaryContactNumber,
    contactname2: empdetails.secondaryContactName,
    contactno2: empdetails.secondaryContactNumber,
    email: empdetails.email,
    gstno: empdetails.gstNo,
    address: empdetails.RegisteredAddress,
    country: empdetails.countries,
    state: empdetails.state,
    district: empdetails.district,
    pincode: empdetails.pinCode,
    location: empdetails.gpsLocat,
    products: empdetails.productDealingWith,
  };
  //formik validation
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const data = {
        ...
        primaryContactNumber: parseInt(values.contactno),
                ...
                <select
                  ...
                  className={
                    formik.touched.type && formik.errors.type
                      ? "input-primary bg-whitecolor focus-outline-none ring-2 ring-secondary border-none"
